...
def match_bracket_index_finder(code, index, direction):
    counter = 1
    i = index + direction
...
def interpreter(code, tape):
    ...
    while code_index < len(code) and 0 <= tape_index < len(result):
        ...
        if current == ">":
            ...
            tape_index -= 1
        elif current == "*" and result[tape_index] == "0":
            result[tape_index] = "1"
        elif current == "*" and result[tape_index] == "1":
            result[tape_index] = "0"
        elif current == "[" and result[tape_index] == "0":
            code_index = match_bracket_index_finder(code, code_index, +1)
        elif current == "]" and result[tape_index] != "0":
            code_index = match_bracket_index_finder(code, code_index, -1)
            code_index -= 1
